...
public class EmbeddedObjectSerializationTest extends DocumentDBBaseTest {
  ...
  public void testEmbeddedObjectSerializationInsideOfOtherEmbeddedObjects() {
    ...
    final OCompositeKey compositeKeyTwo = new OCompositeKey(245, "63", new Date(System.currentTimeMillis() + 100),
        new ORecordId("#0:2"));
    final OCompositeKey compositeKeyThree = new OCompositeKey(36, "563", new Date(System.currentTimeMillis() + 1000),
        new ORecordId("#0:23"));
