...
public class LuceneSpatialGeometryCollectionTest extends BaseSpatialLuceneTest {
  ...
  public void testGeoCollectionOutsideTx() {
    ...
    polygon.field("coordinates", Arrays.asList(Arrays
        .asList(Arrays.asList(0.0, 0.0), Arrays.asList(10.0, 0.0), Arrays.asList(10.0, 10.0), Arrays.asList(0.0, 10.0),
    ...
    List<ODocument> execute = db
        .command(new OCommandSQL("SELECT from test where ST_Contains(geometry, ST_GeomFromText('POINT(1 1)')) = true")).execute();
