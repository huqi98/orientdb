...
/**
 * It contains and manages an OutputStream at different and desired levels. The default OutputStream is 'System.out', but it's
 * possible to instantiate the class with a specific one by passing it to the class Constructor. Levels: - 0 : no output - 3 : only
 * error level is printed - 2 : from info to error is printed - 1 : from debug to error is printed
 *
