  ...
  public V newInstance(final K iKey) {
    ...
    if (cls != null) {
      try {
        ...
        final OSystemException exception = new OSystemException(
            String.format("Error on creating new instance of class '%s' registered in factory with key '%s'", cls, iKey));
