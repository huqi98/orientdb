...
public abstract class OBooleanExpression extends SimpleNode {
  ...
  /**
   * returns true only if the expression does not need any further evaluation (eg. "true")  and always evaluates to true. It is
   * supposed to be used as and optimization, and is allowed to return false negatives
   *
   * @return
   */
  public boolean isAlwaysTrue() {
