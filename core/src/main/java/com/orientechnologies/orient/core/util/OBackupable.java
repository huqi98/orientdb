...
public interface OBackupable {
   ...
   * @param compressionLevel ZIP Compression level between 1 (the minimum) and 9 (maximum). The bigger is the compression, the
   ...
   * @see ODatabaseExport
   */
  List<String> backup(OutputStream out, Map<String, Object> options, Callable<Object> callable, OCommandOutputListener iListener,
