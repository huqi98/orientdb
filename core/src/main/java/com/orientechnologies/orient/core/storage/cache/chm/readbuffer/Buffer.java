 ...
 * Unlike a queue and stack, a buffer does not guarantee an ordering of elements in either FIFO or LIFO order. Beware that it is the
 * responsibility of the caller to ensure that a consumer has exclusive read access to the buffer. This implementation does
...
public interface Buffer<E> {
   ...
   * The addition is allowed to fail spuriously if multiple threads insert concurrently.
   *
  ...
  /**
   * Drains the buffer, sending each element to the consumer for processing. The caller must ensure that a consumer has exclusive
