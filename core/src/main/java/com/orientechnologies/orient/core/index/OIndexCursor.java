 ...
 * <p>
 * Contract of cursor is simple it iterates in some subset of index data till it reaches it's borders in such case {@link
 * #nextEntry()} returns <code>null</code>.
 * <p>
 * Cursor is created as result of index query method such as {@link com.orientechnologies.orient.core.index.OIndex#streamEntriesBetween(Object,
 * boolean, Object, boolean, boolean)} cursor instance cannot be used at several threads simultaneously.
 *
