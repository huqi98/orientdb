...
public interface ORecordSchemaAware {
   ...
   * @param iFieldName  Field name
   * @param iFieldValue Field value to set
   * @param iType       Type between the values defined in the {@link com.orientechnologies.orient.core.metadata.schema.OType} enum
   * @return
   */
  ...
  /**
   * Validates the record against the schema constraints if defined. If the record breaks the validation rules, then a {@link
   * OValidationException} exception is thrown.
   *
