...
public class OSecurityResourceDatabaseOp extends OSecurityResource {
  ...
  public static OSecurityResourceDatabaseOp COMMAND           = new OSecurityResourceDatabaseOp("database.command");
  public static OSecurityResourceDatabaseOp COMMAND_GREMLIN   = new OSecurityResourceDatabaseOp("database.command.gremlin");
