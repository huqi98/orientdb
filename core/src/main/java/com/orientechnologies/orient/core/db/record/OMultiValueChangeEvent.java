...
public class OMultiValueChangeEvent<K, V> {
  ...
  public boolean equals(Object o) {
    ...
    return changeType == that.changeType && !(key != null ? !key.equals(that.key) : that.key != null) && !(oldValue != null ?
        !oldValue.equals(that.oldValue) :
        that.oldValue != null) && !(value != null ? !value.equals(that.value) : that.value != null);
