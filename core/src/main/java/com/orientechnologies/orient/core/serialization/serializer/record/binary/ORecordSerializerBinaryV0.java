    ...
    public class ORecordSerializerBinaryV0 implements ODocumentSerializer {
      ...
      public void serialize(final ODocument document, final BytesContainer bytes, OImmutableSchema schema,
      ...
      protected Map<Object, OIdentifiable> readLinkMap(final BytesContainer bytes, final ORecordElement owner,
          boolean justRunThrough, OImmutableSchema schema) {
