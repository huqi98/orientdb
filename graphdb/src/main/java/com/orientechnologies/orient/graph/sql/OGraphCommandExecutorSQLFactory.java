...
public class OGraphCommandExecutorSQLFactory implements OCommandExecutorSQLFactory {
  ...
  static {
    COMMANDS = Collections.EMPTY_MAP;
  }
   ...
   *
   * @param autoStartTx Whether returned graph will start transaction before each operation till commit automatically or user should
   *                    do it explicitly be calling {@link OrientGraph#getRawGraph()} method {@link ODatabaseDocumentTx#begin()}.
