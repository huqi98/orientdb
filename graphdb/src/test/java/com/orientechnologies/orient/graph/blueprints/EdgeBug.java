...
public class EdgeBug {
  ...
  private OServer setupDatabase() throws Exception {
    ...
    ret.startup("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>" + "<orient-server>" + "<network>" + "<protocols>"
        ...
        + "</storages>" + "<properties>" + "<entry name=\"orientdb.www.path\" value=\"/Users/curtis/orientdb-graphed-1.3.0/www/\"/>"
